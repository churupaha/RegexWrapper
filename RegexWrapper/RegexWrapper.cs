...
{
    #region Обертка для static Regex Split
    ...
    #endregion Обертка для static Regex Split

    #region Обертка для static Regex Matches
    ...
    #endregion Обертка для static Regex Matches

    #region Обертка для static Regex Match
    ...
    #endregion Обертка для static Regex Match

    #region Обертка для static Regex IsMatch
    ...
    #endregion Обертка для static Regex IsMatch

    #region Обертка для static Regex Replace
    ...
    #endregion Обертка для static Regex Replace
